...
public class SearchBookCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("SearchBookCategoryServlet _ SQLException: " + ex.getMessage());
        } catch (NamingException ex) {
            log("SearchBookCategoryServlet _ NamingException: " + ex.getMessage());
        } catch (IOException ex) {
            log("SearchBookCategoryServlet _ IOException: " + ex.getMessage());
        } finally {
