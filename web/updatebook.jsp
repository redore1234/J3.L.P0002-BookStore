<%-- 
    Document   : nupdatebook
    Created on : Dec 9, 2020, 9:01:34 PM
    Author     : phamt
--%>
                    ...
                    <form action="DispatchController" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="txtTitle" 
                                   value="${productDetail.title}" maxlength="50" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="txtQuantity"  
                                   ...
                                   min="1" max="500000" value="${productDetail.quantity}" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="txtAuthor" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'
                                   value="${productDetail.author}" maxlength="50" required/>
                            <small  class="text-muted">Must be 8-50 chars</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="txtDescription" cols="20" rows="10"
                                      value="${productDetail.description}" maxlength="200" required></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="txtPrice"  
                                   onkeypress=" return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57"  
                                   min="0" max="500000" value="${productDetail.price}" required/>
                            <small  class="text-muted">Must greater than 0</small>
                        </div>
